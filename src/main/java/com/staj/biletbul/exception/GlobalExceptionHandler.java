...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(AllTicketsReservedException.class)
    public ResponseEntity<ErrorResponse> handleAllTicketsReservedException
            (AllTicketsReservedException ex) {
        ErrorResponse errorResponse = new ErrorResponse();
        errorResponse.setMessage(ex.getMessage());
        errorResponse.setStatus(HttpStatus.CONFLICT.value());
        errorResponse.setTimestamp(LocalDateTime.now());
    ...
    @ExceptionHandler(SeatNotBelongsToTicketTypeException.class)
    public ResponseEntity<ErrorResponse> handleSeatNotBelongsToTicketTypeException
            (SeatNotBelongsToTicketTypeException ex) {
        ErrorResponse errorResponse = new ErrorResponse();
        errorResponse.setMessage(ex.getMessage());
        errorResponse.setStatus(HttpStatus.CONFLICT.value());
        errorResponse.setTimestamp(LocalDateTime.now());
    ...
    public ResponseEntity<ErrorResponse> handleEventNotActiveException
            (EventNotActiveException ex) {
        ErrorResponse errorResponse = new ErrorResponse();
        errorResponse.setMessage(ex.getMessage());
        errorResponse.setStatus(HttpStatus.CONFLICT.value());
        errorResponse.setTimestamp(LocalDateTime.now());
    ...
    @ExceptionHandler(EventNotBelongsToOrganizerException.class)
    public ResponseEntity<ErrorResponse> handleEventNotBelongsToOrganizerException
            (EventNotBelongsToOrganizerException ex) {
        ErrorResponse errorResponse = new ErrorResponse();
        errorResponse.setMessage(ex.getMessage());
        errorResponse.setStatus(HttpStatus.CONFLICT.value());
        errorResponse.setTimestamp(LocalDateTime.now());
    ...
    public ResponseEntity<ErrorResponse> handleEventAlreadyConfirmedException
            (EventAlreadyConfirmedException ex) {
        ErrorResponse errorResponse = new ErrorResponse();
        errorResponse.setMessage(ex.getMessage());
        errorResponse.setStatus(HttpStatus.CONFLICT.value());
        errorResponse.setTimestamp(LocalDateTime.now());
    ...
    public ResponseEntity<ErrorResponse> handleIllegalArgumantException
